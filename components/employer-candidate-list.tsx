...
export default function EmployerCandidateList() {
  ...
  const handleDownload = (candidateName: string) => {
    const filename = `${candidateName.replace(/\s+/g, "_")}_report.txt`;
    const element = document.createElement("a");
    const fileContent = `SkillKwiz Verified Skill Assessment Report\n=========================================\n\nCandidate Name: ${candidateName}\nCompany: SkillKwizz\nSkills Evaluated: C#, Java, SQL\nPercentile Score: 85%\nStatus: VERIFIED\n\nThis is a verified skill assessment report generated by SkillKwiz.`;
            ...
            <div key={candidate.id} className="bg-[#4a63b3]/80 rounded-lg p-4">
              <div className="flex items-center justify-between">
                  ...
                  <div>
                    <h3 className="text-xl font-medium">
                      <a
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          handleDownload(candidate.name);
                        }}
                        className="text-cyan-300 hover:text-cyan-100 hover:underline transition-colors font-semibold"
                      >
                        {candidate.name}
                      </a>
                    </h3>
                ...
                <button
                  ...
                  className="bg-[#00bcd4] text-white px-4 py-2 rounded-lg hover:bg-[#00a5bb] transition-colors"
                >
                  View Report
                </button>
              </div>
