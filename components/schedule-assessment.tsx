    ...
    <div className="text-white">
      ...
      <div className="space-y-8">
        ...
        <div className="flex justify-center mt-8">
          <button
            ...
            className="px-20 py-2.5 rounded bg-gradient-to-r from-[#4ECDC4] to-[#2d8a84] text-white hover:opacity-90 font-semibold transition-all shadow-md"
          >
            Submit
          </button>
        </div>
      ...
      {showSuccess && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm z-50 p-4">
          <div className="bg-[#1f293d] border border-gray-700 p-8 rounded-xl max-w-md w-full text-center shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <h3 className="text-2xl font-bold text-white mb-2">Slot Scheduled!</h3>
            <p className="text-gray-300 mb-6 text-sm">
              Thank you! Your skill assessment slot has been successfully scheduled. A confirmation email with details has been sent to you.
            </p>
            <button
              onClick={() => setShowSuccess(false)}
              className="w-full py-2.5 bg-gradient-to-r from-[#4ECDC4] to-[#2d8a84] text-white font-semibold rounded-md hover:opacity-95 transition-all shadow-sm"
            >
              Close
            </button>
          </div>
