    ...
    <section className="py-10 bg-[#000c2a]">
      <div className="max-w-5xl mx-auto px-6">
        <div className="bg-white rounded-lg overflow-hidden shadow-xl flex flex-col md:flex-row">
          {/* Left side - Light Image */}
          <div className="w-full md:w-1/2 relative min-h-[350px] bg-gray-50 flex items-center justify-center p-8">
            <Image
            ...
            <div className="w-full">
              ...
              <form className="space-y-4">
                ...
                <div className="text-center text-white">
                  ...
                  <p className="text-sm border-t border-blue-700/50 pt-3">
                    Don't have an account?{" "}
                    <a href="/services" className="text-[#f6c648] hover:text-[#f7d03e] hover:underline font-semibold">
                      Sign Up
                    </a>
                  </p>
                </div>
